...
const techStack: Tech[] = [
  ...
  { icon: <SiNextdotjs className={iconClass} />, label: "Next.js" },
  { icon: <SiPostgresql className={iconClass} />, label: "PostgreSQL" },
  { icon: <SiMysql className={iconClass} />, label: "MySQL" },
  { icon: <SiAmazonwebservices className={iconClass} />, label: "AWS" },
  { icon: <SiSlack className={iconClass} />, label: "Slack API" },
